...
<script>
    $(document).ready(function () {
        ...
        $('.playbackBar .progressBar, .volumeBar .progressBar, .controlButton').on('touchstart touchmove touchend', function (e) {
            e.stopPropagation();
        });
        ...
        $('.playbackBar .progressBar').on('touchstart', function (e) {
            mouseDown = true;
            e.preventDefault();
        });
        $('.playbackBar .progressBar').on('touchmove', function (e) {
            if (mouseDown) {
        ...
        $('.playbackBar .progressBar').on('touchend', function (e) {
            mouseDown = false;
            e.preventDefault();
        });
        ...
        // Touch events for volume bar
        $('.volumeBar .progressBar').on('touchstart', function (e) {
            mouseDown = true;
            e.preventDefault();
        });
        $('.volumeBar .progressBar').on('touchmove', function (e) {
            if (mouseDown) {
                var touch = e.originalEvent.touches[0];
                var rect = this.getBoundingClientRect();
                var offsetX = touch.clientX - rect.left;
...
<style>
    ...
    .controlButton.play img:active,
    .controlButton.pause img:active {
        transform: scale(1.4);
    }
